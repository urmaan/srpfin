...
const featureData = [
    {
        title: `Dual Rewards`,
        body: "Scorpion Finance is the next iteration of a reflection token on the Binance Smart Chain (BSC), world's 4th and Europe's first. The unique double reward reflection will be 10% in BNB and 5% in ScorpFin token. Simply hold ScorpFin tokens and get paid, from every buy and sell.",
        sub:"(10% BNB & 5% Scorpfin)", lottie:reward
    },
    {
        title: "VR and AR multiverse Gaming",
        body: "World's first VR and AR multiverse games in crypto. For the very first time, players will get to experience the fusion of crypto, virtual reality and augmented reality in the multiverse world. Earn tokens, coins and NFTs for completing stages of the game. Think Game, Think Reality"
,sub:" ",lottie:game
    },
    {
...
,sub:" ", lottie:dapps    },
    ...
    return (
        <div className="grid lg:grid-cols-3 px-2 xl:px-48 lg:px-32 mt-10 lg:mt-0">
            {
